...
public class About extends JFrame {
	...
	public About() {
		...
		JLabel lblnoman = new JLabel("Md Noman");
		lblnoman.setForeground(new Color(100, 149, 237));
		lblnoman.setFont(new Font("Tahoma", Font.BOLD, 24));
		lblnoman.setHorizontalAlignment(SwingConstants.CENTER);

		JLabel lblId = new JLabel("ID : 203-35-680");
		lblId.setForeground(new Color(199, 21, 133));
		lblId.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 21));
		lblId.setHorizontalAlignment(SwingConstants.CENTER);

		JLabel lblSec = new JLabel("SEC : C");
		...
		JLabel lbl_Java = new JLabel("SE 221");
		...
		gl_contentPane.setHorizontalGroup(
				gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
								.addGap(105)
								.addComponent(lblnoman, GroupLayout.PREFERRED_SIZE, 335,
						...
						.addGroup(gl_contentPane.createSequentialGroup()
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_contentPane.createSequentialGroup()
												.addGap(18)
												.addComponent(lblId, GroupLayout.PREFERRED_SIZE, 262,
														GroupLayout.PREFERRED_SIZE))
										.addComponent(lblSec, GroupLayout.PREFERRED_SIZE, 262,
												GroupLayout.PREFERRED_SIZE))));
		gl_contentPane.setVerticalGroup(
				gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
								.addGap(6)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(btn_Menu, GroupLayout.PREFERRED_SIZE, 35,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(btnExit, GroupLayout.PREFERRED_SIZE, 35,
												GroupLayout.PREFERRED_SIZE))
								.addGap(10)
								...
								.addGap(18)
								.addComponent(lblnoman, GroupLayout.PREFERRED_SIZE, 52,
										GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(lblId, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
										.addGroup(gl_contentPane.createSequentialGroup()
												.addGap(32)
												.addComponent(lblSec, GroupLayout.PREFERRED_SIZE, 35,
														GroupLayout.PREFERRED_SIZE)))));
